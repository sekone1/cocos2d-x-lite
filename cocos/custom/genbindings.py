...
def _check_ndk_root_env():
    ...
    try:
        NDK_ROOT = "/Users/songqinghui/Documents/cocos2dx/creator/android-ndk-r12b"
...
def main():
    ...
    try:
        tojs_root = '%s/../../../custom' % project_root
        output_dir = '%s/../../../custom/js-bindings/auto' % project_root

        cmd_args = {
                    'custom_sdk.ini' : ('custom_sdk', 'jsb_custom_sdk_auto'),
                    }
        target = 'spidermonkey'
